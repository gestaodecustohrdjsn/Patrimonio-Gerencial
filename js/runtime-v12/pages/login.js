    ...
    <main class="login-page">
      <section class="login-card">
        ...
        <form id="loginForm" class="login-form">
          ...
          <button class="primary-button" id="loginButton" type="submit">Entrar</button><small style="display:block;margin-top:12px;color:#66808c">Infraestrutura: API Patrimônio+ · build 1.2</small>
        </form>
      </section>
    </main>`;
